...
def create_user_movie_df():
    ...
    rare_movies = comment_counts[comment_counts["title"] <= 10000].index #İşlem süresinin düşmesi için sayı arttırıldı.
...
random_user = int(pd.Series(user_movie_df.index).sample(1, random_state=365).values)
