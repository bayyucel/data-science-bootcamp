...
#df["value_total"] = df["customer_value_total_ever_offline"] + df["customer_value_total_ever_online"]
#df["average_order_value"] = df["value_total"] / df["order_total"]
#df["average_online"] = df["customer_value_total_ever_online"] / df["order_num_total_ever_online"]
#df["average_offline"] = df["customer_value_total_ever_offline"] / df["order_num_total_ever_offline"]
